...
bgRoad = pg.image.load("C:/Users/User/Documents/PPSPRING/py/pp2-main/lab 9/racer/bgRoad.png")
sharkIm = pg.image.load("C:/Users/User/Documents/PPSPRING/py/pp2-main/lab 9/racer/shark.png")
rocketIm = pg.image.load("C:/Users/User/Documents/PPSPRING/py/pp2-main/lab 9/racer/rocket.png")
bombIm = pg.image.load("C:/Users/User/Documents/PPSPRING/py/pp2-main/lab 9/racer/bomb.png")
...
class Cherry(pg.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pg.image.load("C:/Users/User/Documents/PPSPRING/py/pp2-main/lab 9/racer/cherry.png")
...
class Coin(pg.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pg.image.load("C:/Users/User/Documents/PPSPRING/py/pp2-main/lab 9/racer/coin.png")
        self.rect = self.image.get_rect()
        self.speed = 7
    def move(self):
        global money
...
class Enemy(pg.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pg.image.load("C:/Users/User/Documents/PPSPRING/py/pp2-main/lab 9/racer/bomb.png")
        self.rect = self.image.get_rect()
...
class Shark(pg.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pg.image.load("C:/Users/User/Documents/PPSPRING/py/pp2-main/lab 9/racer/shark.png")
        self.rect = self.image.get_rect()
...
pg.mixer.music.load("C:/Users/User/Documents/PPSPRING/py/pp2-main/lab 9/racer/Teriyaki Boyz - Tokyo drift.mp3")
pg.mixer.music.play()
